...
def generate_ideas(company_link:str, role:str=""):
    """
    ...
    I work in a {role} role at the company, keep this in mind in your response.
    ...
    {
        "idea_1_title": "IDEA 1 DESCRIPTION",
        "idea_2_title": "IDEA 2 DESCRIPTION",
        "idea_3_title": "IDEA 3 DESCRIPTION"
    }
    ...
    ideas = _chat_openai(prompt, system_prompt, MAX_PROMPT_SIZE - (len(prompt) + len(system_prompt)))
    print(ideas)
    return ideas
